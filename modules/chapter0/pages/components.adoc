...
A. Running every migration manually

B. Sharing migration knowledge, reusable rules, and standardized analysis

C. Allowing every team to define its own migration process
